...
import com.apk.task.model.ImageModel;
import com.apk.task.R;
import com.apk.task.adapter.ImageAdapter;
import com.apk.task.adapter.SelectedImageAdapter;
...
public class ImagesActivity extends AppCompatActivity {
    ...
    int[] resImg = {R.drawable.camera, R.drawable.camera};
        ...
        imageList = new ArrayList<>();
            ...
            public void onClick(View v) {
                startActivity(new Intent(ImagesActivity.this, MainActivity.class)
                        .putExtra("imageList", selectedImageList));
            }
        });
    }
    ...
    public void selectImage(int position) {
        order.setText(selectedImageList.size() + 1 + "");
